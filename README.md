...
```shell
kubectl apply -f "https://raw.githubusercontent.com/aleofreddi/csi-sanlock-lvm/v0.4.8/deploy/kubernetes/csi-sanlock-lvm-init.var.yaml"
```
...
kubectl apply -k "https://github.com/aleofreddi/csi-sanlock-lvm/deploy/kubernetes?ref=v0.4.8"
```
